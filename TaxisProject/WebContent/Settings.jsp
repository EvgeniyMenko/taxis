...
<head>
	   ...
	   <script src="resources/js/Future.js"></script>
		...
		<script src="resources/js/AjaxSettingsPage.js"></script>
		
		
	</head>
	<body class="theme-1">
	<div class="container3">
	<a href="?action=settings&sessionLocale=en"><img src="resources/images/UK.png" width="30" 
   height="30"></a>
	<a href="?action=settings&sessionLocale=ru"><img src="resources/images/RU.png" width="30" 
   height="30"></a></div>
		<div class="container">
			...
			<div class="main">
				<header class="codrops-header">
					<h1><fmt:message key="text.taxisCompany" /><span><br> <br><fmt:message key="text.chooseUser" /></span></h1><br>
					<div class="container2"  id="result"></div>
					
				</header>
		<br>
		 
		 <form action="${pageContext.request.contextPath}/home?action=giveAdmin"  method="post">
		 <span class="custom-dropdown big"> 

 

<select  name="login" id="selectBox" required>
    <option selected value=""><fmt:message key="text.chooseUser" /></option>
    <c:forEach items="${allLogin}" var="entry">
    <option data-login="${entry.value}" value="${entry.value}" >${entry.value}</option>
   </c:forEach>
   </select></span><br>
   <input  type="hidden"   name="login"  >
  <button class="btn_login" ><fmt:message key="text.appointAdmin" /></button> 
