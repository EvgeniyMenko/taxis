...
<head>
	...
	<a href="?action=sort&sessionLocale=en"><img src="resources/images/UK.png" width="30" 
   height="30"></a>
	<a href="?action=sort&sessionLocale=ru"><img src="resources/images/RU.png" width="30" 
   height="30"></a></div>
		<div class="container">
			...
			<div class="main">
				<header class="codrops-header">
					...
					<div class="container2"  id="result">${message}</div>
				</header>
				<br>
        ...
        <tbody>
           <c:forEach items="${listTaxis}" var="entry">
         <tr>
          <td align="center">${entry.classCar}</td> 
         <td align="center">${entry.car}</td>
         <td align="center">${entry.carModel}</td>
         <td align="center">${entry.cost}</td>
         <td align="center">${entry.fuelConsumption}</td>
         <td align="center">${entry.acceleration}</td>
         <td align="center">${entry.maxSpeed}</td>  
         <td align="center">${entry.priceForOneMinute}</td>
         </tr>
         </c:forEach>
        </tbody>
    </table>
