...
<head>
	   ...
	   <script src="resources/js/Future.js"></script>
		...
		<script src="resources/js/AjaxDeletePage.js"></script>
		
	</head>
	<body class="theme-1">
	<div class="container3">
	<a href="?action=delete&sessionLocale=en"><img src="resources/images/UK.png" width="30" 
   height="30"></a>
	<a href="?action=delete&sessionLocale=ru"><img src="resources/images/RU.png" width="30" 
   height="30"></a></div>
		<div class="container">
		...
		<br>
		 <form action="/TaxisProject/home?action=deleteResult"  method="post">
...
<input  type="hidden"   name="id"  >
  ...
  <button class="btn_login" ><fmt:message key="text.delete" /></button> 
 </form>
	        <br>
			</div>
